...
ADMIN = int(environ.get('ADMIN', '1447424345'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002778508737'))
...
LINK_URL = environ.get("LINK_URL", "https://arjun1830.blogspot.com/p/a.html")
